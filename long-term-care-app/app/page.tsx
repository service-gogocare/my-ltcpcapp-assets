...
import { Points, CoursePoints, CalculationResults } from '@/lib/types';
import { usePointCalculator } from '@/hooks/usePointCalculator';
import { ResultDisplay } from '@/components/ResultDisplay';
import { UploadIcon, SpinnerIcon, ChevronLeftIcon, ExternalLinkIcon } from '@/components/icons';
...
const App: React.FC = () => {
  ...
  const handleFileUpload = useCallback(async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const extractedPoints = await response.json();
  ...
  const InputForm = (
    <div className="space-y-8">
      <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg">
        <h3 className="text-xl font-bold text-brand-primary dark:text-brand-accent mb-4">區段一：課程屬性積分</h3>
      ...
      <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg">
        <h3 className="text-xl font-bold text-brand-primary dark:text-brand-accent mb-4">區段二：課程類別積分</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg">
        <h3 className="text-xl font-bold text-brand-primary dark:text-brand-accent mb-4">區段三：文化敏感度課程</h3>
